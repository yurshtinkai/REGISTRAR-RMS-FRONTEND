...
function SettingsPage() {
    ...
    const handleEditProfile = () => {
        ...
        const currentEmail = currentProfile.email || localStorage.getItem('email') || 'admin@benedicto.edu.ph';
                                        ...
                                        <div className="card border-0 bg-light">
                                            <div className="card-body">
                                                ...
                                                <div className="row mb-2">
                                                    ...
                                                    <div className="col-6">
                                                        <span className={`badge ${userRole === 'admin' ? 'bg-primary' : 'bg-info'}`}>
                                                            {userRole === 'admin' ? 'Registrar' : 'Accounting'}
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
